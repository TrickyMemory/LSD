  ...
  <div id="wrapper">
    <div class="container-fluid">
      <div class="row">
        <div class="col-lg-5">
          <center>
          <img class="img-circle" width="300" height="300" alt="Generic placeholder image"
      ...
      <div class="row">
        <div class="col-lg-10">
          ...
          <!--generer la liste des contacts disponible pour une asso-->
          <p>contact 1 : knqks.fr</p>
          <p>contact 2 : isn@dfskf.fr</p>
          </center>
        </div>
      </div>
    </div>
